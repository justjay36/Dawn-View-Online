...
function showFirstLaunchWelcome(){
  ...
  if(!dialog)return;
  let seen=false;
  try{seen=Boolean(localStorage.getItem("dawnview-online-v0.2-welcome"));}catch{}
